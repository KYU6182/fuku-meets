    ...
    <section className="bg-white px-4 pt-10">
      <article className="relative overflow-hidden rounded-[14px] border border-fuku-border bg-[#f5f0e8] p-5">
        <div className="relative z-10 max-w-[210px]">
          ...
          <a href="/forms/paper-placement" className="mt-4 block text-[11px] font-black text-fuku-gray">
            フリーペーパー設置申請 →
          </a>
        </div>
        ...
        <div
          ...
          style={{ backgroundImage: "url('/images/paper-cover.jpg')" }}
        >
