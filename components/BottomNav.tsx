import { Crown, Home, MessageCircle, Sparkles, User } from "lucide-react";

type BottomNavActive = "home" | "ranking" | "meet" | "chat" | "news" | "search" | "mypage";

const tabs = [
  { id: "home", label: "HOME", href: "/", icon: Home },
  { id: "ranking", label: "RANKING", href: "/ranking", icon: Crown },
  { id: "meet", label: "今夜のMEET", href: "/meet", icon: Sparkles },
  { id: "chat", label: "CHAT", href: "/mypage/chats", icon: MessageCircle },
